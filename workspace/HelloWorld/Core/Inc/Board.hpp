...
public:
	...
	void TimerEvent(RTC_TimeTypeDef sTime, RTC_DateTypeDef sDate);
...
private:
	...
	int currentHolidayHour;
	int currentHolidayMinute;
	...
	void StoreSettings();
	std::string * ParseBodyLines(std::string body, int * parameterCount);
